...
export const Vortex = (props) => {
  ...
  const draw = (canvas, ctx) => {
    ...
    // Set the background color from the props
    //ctx.fillStyle = "#080D27";
    ctx.fillRect(0, 0, canvas.width, canvas.height);

    // Draw particles and other effects
    drawParticles(ctx);
  ...
  return (
    <div className={cn("relative h-full w-full", props.containerClassName)}>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        ref={containerRef}
        className="absolute h-full w-full inset-0 z-0 bg-s1 flex items-center justify-center"
      >
