...
const Pricing = () => {
  ...
  const [isMonthly, setIsMonthly] = useState(plans.map(() => false));

  const handleToggle = (index) => {
    // Create a new array with the toggled value for the specific plan
    const updatedIsMonthly = [...isMonthly];
    updatedIsMonthly[index] = !updatedIsMonthly[index];
                ...
                <div className="relative z-4 mx-auto flex w-[275px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[250px] max-lg:w-[260px] mb-3">
                  ...
                  <div
                    className={clsx(
                      ...
                      !isMonthly[index] && "translate-x-full",
                    )}
                  />
                </div>
